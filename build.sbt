...
libraryDependencies ++= Seq(
  ...
  "org.elasticsearch" % "elasticsearch-spark-20_2.10" % "6.2.2",
  "org.apache.spark" %% "spark-sql-kafka-0-10" % "2.4.2",// problem with google methods, exclude google guava is requierd
